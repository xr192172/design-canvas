// Package probe implements the "observe" layer of dynamic instrumentation.
//
// Coverage counters (go tool cover) are the "stopwatch" — they say how often a
// path runs. Probes are the "observe": they capture the actual data values
...
// 修复落于历史本地分叉，2026-08-18 回迁归位到 go-observe）：
...
// the observe-dsl loop can read directly.
