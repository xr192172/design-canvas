...
describe('Observe 即时判定器 · silent-error-discard', () => {
  it('err 为空 → ok', () => {
...
describe('Observe 即时判定器 · judgeEvent', () => {
  it('多条规则，首条命中偏差即返回', () => {
...
describe('Observe 即时判定器 · impact-blast-radius（Step 3 合流）', () => {
...
describe('Observe 即时判定器 · impact-unplanned-spread（Impact Ledger）', () => {
