/**
 * Camera 判定下沉服务测试：验证语言无关的判定服务（judge_service）语义，
...
import { normalizeEvents, judgeEvents, renderJudgeReport } from '../../src/camera/judge_service.js';
...
describe('Camera 判定服务 · normalizeEvents', () => {
  it('非数组入参返回 error', () => {
...
describe('Camera 判定服务 · judgeEvents', () => {
...
describe('Camera 判定服务 · renderJudgeReport', () => {
  it('无偏差输出单行 ✓', () => {
