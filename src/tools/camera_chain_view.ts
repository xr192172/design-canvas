/**
 * camera_chain_view —— 链路契约 + chain-broken 偏差可视化（自包含 HTML，可目验）
 *
...
import type { TSDLDecl, TSDeviation, TSDiffReport } from '../camera/contract.js';
import type { TSChainObs } from '../camera/chain.js';

/** 视图输入：已判定的链路数据（外部用 camera/contract TSComparator + chain 装配）。 */
